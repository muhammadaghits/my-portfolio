...
<template>
	...
	>
		...
		<div class="w-full md:w-1/3 text-left">
			<h1
				class="font-general-bold text-3xl md:text-3xl xl:text-4xl text-center sm:text-left text-ternary-dark dark:text-primary-light uppercase mb-2"
			>
				Hello!, I'm
			</h1>
      <h1
          class="font-general-bold text-3xl md:text-3xl xl:text-4xl text-center sm:text-left text-ternary-dark dark:text-primary-light uppercase"
      >
        Muhammad Aghits
      </h1>
			<p
